<template>
  ...
  >
    <div class="text-left w-50">
      <h2>ElectronMuck</h2>
      <p>
        This is a project trying to create a MUD-compatible client using Vue,
        Electron, and Telnet. Rights reserved... until I figure out an
        appropriate license.
      </p>
      <h5>Links</h5>
      <h2>
        <a
          href="https://github.com/SveinungTorresdal/ElectronMuck"
          target="_blank"
        >
      ...
      <h5>Credits</h5>
      <p>
        Shout-out to all of these big projects that set the foundation of what
        we're doing.
      </p>
      <h2>
        <a href="https://git-scm.com/" target="_blank" class="mr-2">
          <font-awesome-icon :icon="['fab', 'git-alt']" />
        </a>
        <a href="https://nodejs.org/en/" target="_blank" class="mr-2">
          <font-awesome-icon :icon="['fab', 'node-js']" />
        </a>
        <a href="https://www.npmjs.com/" target="_blank" class="mr-2">
        ...
        <a href="https://getbootstrap.com/" target="_blank" class="mr-2">
          <font-awesome-icon :icon="['fab', 'bootstrap']" />
        </a>
      </h2>
      <p>Additional credit goes to...</p>
      <ul>
        <li>
          <a
            ...
            >Electron Builder</a
          >
          - quickly create an app with Vue CLI.
        </li>
        <li>
          <a href="https://bootstrap-vue.org/" target="_blank">BootstrapVue</a>
          - to quickly build a functional app.
        </li>
        <li>
          <a href="https://fontawesome.com/" target="_blank">FontAwesome</a>
          - for all my iconography needs.
        </li>
      </ul>
    </div>
  </div>
